...
<!-- 
Enunciado: Escreva um código em PHP que recebe o nome de um dia da semana e exibe uma mensagem correspondente:
...
<!-- 
Enunciado: Escreva um código em PHP que recebe dois números e uma operação matemática básica (+, -, *, /). 
